/* This file is used to store secret variables that the bot uses to request API usage.
 * Do not show these secrets to anyone or use these for any purpose other than this bot.
 */
